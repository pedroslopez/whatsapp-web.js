...
client.on('qr', async (qr) => {
    ...
    if (pairingCodeEnabled && !pairingCodeRequested) {
        const pairingCode = await client.requestPairingCode('556993161840'); // enter the target phone number
        console.log('Pairing code enabled, code: ' + pairingCode.split('').join(' '));
...
client.on('message', async msg => {
    ...
    if (msg.body === '!ping reply') {
        ...
        client.sendMessage(msg.from, 'pong', 2000);
