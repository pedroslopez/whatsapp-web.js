...
exports.ExposeStore = (moduleRaidStr) => {
    ...
    if (window.Store.Conn[0].Conn) window.Store.Conn = window.mR.findModule('Conn')[0].Conn;
    else if (window.Store.Conn[1].Conn) window.Store.Conn = window.mR.findModule('Conn')[1].Conn;
