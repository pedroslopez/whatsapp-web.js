...
class Client extends EventEmitter {
    ...
    async acceptGroupV4Invite(inviteInfo) {
        ...
        return this.pupPage.evaluate(async inviteInfo => {
            ...
            let wid = window.Store.WidFactory.createWid(fromId);
            return await window.Store.JoinInviteV4.joinGroupViaInviteV4(inviteCode, String(inviteCodeExp), groupId, wid);
        }, inviteInfo);
    }
