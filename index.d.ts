...
declare namespace WAWebJS {
    ...
    export class Client extends EventEmitter {
         ...
         * @options
         * limit: The maximum number of chats to be retrieved.
         * lastMessage: If set to true, the last message will be returned for each chat. Default: true
         *  */
        getChats(options?: { limit?: number, lastMessage?: boolean }): Promise<Chat[]>
